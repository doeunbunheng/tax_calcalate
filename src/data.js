...
export const T = {
  en: {
    ...
    taxes18: "18 Taxes",
    tabs: {
      overview: "Overview", salary: "Salary Tax",       prepayment: "Payment Tax",
    ...
    prepayment: {
      title: "Payment Tax Calculator", sub: "Monthly 1% advance payment toward annual profit tax.",
  ...
  kh: {
    ...
    tabs: {
      ...
      dividend: "ពន្ធភាគលាភ", minimum: "ពន្ធអប្បបរមា", rent: "ពន្ធជួលដីនិងអចលនទ្រព្យ",
...
export const TAXES = [
  ...
  { id: "rent", en: "Rent & Land Tax", kh: "ពន្ធជួលដីនិងអចលនទ្រព្យ", cat: "transaction", icon: "", rate: "10%", due: "Monthly", formulaEn: "Rental Income × 10%", formulaKh: "ប្រាក់ជួល × ១០%", defEn: "10% on rental income.", defKh: "ពន្ធឈ្នួលផ្ទះ និងដី គឺជាពន្ធដែលគិតលើប្រាក់ចំណូលពីការជួលផ្ទះ ដី អគារ ឬអចលនទ្រព្យផ្សេងៗ។ ជាទូទៅ វាត្រូវបានគិតក្នុងអត្រា ១០% លើប្រាក់ជួល។" },
